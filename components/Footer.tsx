  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Col 2 — Analysis */}
        <div>
          <div style={COL_LABEL}>Analysis</div>
          {ANALYSIS_LINKS.map((l) => <FooterLink key={l.href} {...l} />)}
        </div>

        {/* Col 3 — Documentation */}
        <div>
          <div style={COL_LABEL}>Documentation</div>
          {DOC_LINKS.map((l) => <FooterLink key={l.href} {...l} />)}
        </div>

        {/* Col 4 — About */}
        <div>
          <div style={COL_LABEL}>About</div>
          <p
            style={{
              fontFamily: "var(--font)",
              fontSize: 11,
          ...
          >
            A capstone project by the INFM737 team at the University of Maryland, in
            partnership with NXT Partner LLC.
          </p>
          <p
            style={{
              fontFamily: "var(--mono)",
