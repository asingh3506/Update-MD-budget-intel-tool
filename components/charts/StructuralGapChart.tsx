          ...
          annotations: [
            {
              ...
              showarrow: false,
              font: { color: "#B8860B", size: 9, family: "Montserrat,Arial,sans-serif" },
              yanchor: "bottom",
            },
            {
              ...
              arrowhead: 2,
              arrowcolor: "#C41230",
              font: { color: "#C41230", size: 11, family: "Montserrat,Arial,sans-serif" },
              ax: -60, ay: -20,
            },
            {
              ...
              arrowhead: 2,
              arrowcolor: "#C41230",
              font: { color: "#C41230", size: 10, family: "Montserrat,Arial,sans-serif" },
              ax: -50, ay: -30,
            },
          ],
        }}
      ...
      <div style={{ marginTop: 4 }}>
        <Plot
          ...
          layout={{
            paper_bgcolor: "white",
            plot_bgcolor: "white",
            font: { family: "Montserrat,Arial,sans-serif", size: 10, color: "#121212" },
